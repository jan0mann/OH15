namespace WorldOfZuul
{
    public class Game
    {
        ...
        private void CreateRooms()
        {
            ...
            Room? MainIsland = new("Main Island", "You are standing on the main Island in the middle of the pacific ocean. To the east is a large building, to the south is a computing lab, and to the west is the campus pub.");
            ...
            MainIsland.SetExits(null, OilSpill, lab, PlasticWaste); // North, East, South, West
